...
namespace FroggerProject
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            boss1.Initialize(VioletBoss, VioletBossPosition, bossLive, health);  // เลข 2 ตัวหลังเพิ่มชีวิตกับเลือด
            ...
            boss2.Initialize(OrangeBoss, OrangeBossPosition, bossLive, health);  // เลข 2 ตัวหลังเพิ่มชีวิตกับเลือด
            ...
            boss3.Initialize(BlueBoss, BlueBossPosition, bossLive, health);  // เลข 2 ตัวหลังเพิ่มชีวิตกับเลือด
            ...
            boss4.Initialize(RedBoss, RedBossPosition, bossLive, health);  // เลข 2 ตัวหลังเพิ่มชีวิตกับเลือด
            ...
            boss5.Initialize(GreenBoss, GreenBossPosition, bossLive, health);  // เลข 2 ตัวหลังเพิ่มชีวิตกับเลือด
